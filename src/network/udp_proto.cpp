...
bool
    UdpProtocol::OnKeepAlive(UdpMsg* msg, int len) //wtf?
    {
       return true;
    }

void
    UdpProtocol::GetNetworkStats(struct GGPONetworkStats* s) //wow great variable name tony GOOD FUCKING NAME
    {
